    ...
    static setupScrollQuotePopup() {
        ...
        const triggerPopup = () => {
            ...
            popup.innerHTML = `
                ...
                <p style="margin: 0 0 0.85rem; font-size: 0.84rem; color: #64748B; line-height: 1.45;">Chat directly with our lead developers in Nairobi on WhatsApp. Transparent packages from <strong style="color: #0F172A;">KES 25,000</strong> with free domain &amp; hosting.</p>
